...
export default function ProductsPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      ...
      const filteredProducts = data.filter((product: Product) => product.category_id === 7);
  ...
  return (
    <div>
      ...
      <Breadcrumbs aria-label="breadcrumb" className="breadcrumbs" separator=">">
        <Link href="/">Home</Link>
        <Typography color="textPrimary">Bird Food</Typography>
      </Breadcrumbs>

      <div className="container">
        <h1 className="page-title">Bird Food</h1>
