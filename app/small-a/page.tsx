...
export default function ProductsPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      ...
      const filteredProducts = data.filter((product: Product) => product.category_id === 8);
  ...
  return (
    <div>
      ...
      <Breadcrumbs aria-label="breadcrumb" className="breadcrumbs" separator=">">
        <Link href="/">Home</Link>
        <Typography color="textPrimary">Small Animal food</Typography>
      </Breadcrumbs>

      <div className="container">
        <h1 className="page-title">Small Animal food</h1>
